...
/**
 * Main: Install the release version of dojo. (About 4MB)
 */
target(downloadRelease: "This will download and install the full dojo toolkit into the application.") {
 ...
 */
target(downloadSource: "This will download the source version of Dojo.") {
...
/**
 * DownloadSource - This will do the same as call the shell script to create the optimized
