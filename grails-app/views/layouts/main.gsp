...
<head>
    ...
    <dojo:header theme="tundra"  modulePaths="['appwidgets':'appwidgets']" modules="['dijit.layout.TabContainer','dijit.layout.ContentPane','appwidgets.CustomWidget', 'dojo.io.iframe']" showSpinner="true"/>
    <dojo:menuResources/>
