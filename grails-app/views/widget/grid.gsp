...
<head>
  ...
  <dojo:header theme="tundra" debug="true"/>
...
<body class="tundra">
  ...
  <dojo:grid class="dojoGridInGrails" controller="widget" action="listJson" id="myGrid" sort="name" rowHeight="30" style="height:400px">
