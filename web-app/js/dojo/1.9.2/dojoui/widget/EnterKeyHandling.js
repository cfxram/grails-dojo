define(["dojo/_base/declare", "dijit/_editor/plugins/EnterKeyHandling", "dojo/dom-construct", // domConstruct.destroy domConstruct.place
    	...
    	"dijit/_editor/range",
    	"dijit/_base/focus"],
function(declare, EKH, domConstruct, keys, lang, on, has, win, winUtils, RichText, rangeapi, baseFocus){
	return declare("dojoui.widget.EnterKeyHandling", EKH, {
		// summary:
		...
		handleEnterKey: function(e){
			...
			if(e.shiftKey){		// shift+enter always generates <br>
				...
				if(header){
					...
					if(range.atBeginningOfContainer(header, range.startContainer, range.startOffset)){
					...
					if(selection.rangeCount){
						...
						if(range && range.startContainer){
							...
							if(rs && rs.nodeType == 3){
								...
								domConstruct.place(endNode, brNode, "after");
								domConstruct.destroy(rs);
								newrange = rangeapi.create(dojo.gobal);
								newrange.setStart(endNode,0);
