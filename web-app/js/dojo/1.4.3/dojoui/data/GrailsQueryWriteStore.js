dojo.provide("dojoui.data.GrailsQueryWriteStore");
dojo.require("dojoui.data.GrailsQueryReadStore");

dojo.declare("dojoui.data.GrailsQueryWriteStore",dojoui.data.GrailsQueryReadStore,{
