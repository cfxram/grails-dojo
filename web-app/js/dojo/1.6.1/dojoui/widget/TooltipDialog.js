dojo.provide("dojoui.widget.TooltipDialog");
...
dojo.declare("dojoui.widget.TooltipDialog",[dojoui.layout.ContentPane, dijit._Templated, dijit.form._FormMixin, dijit._DialogMixin],{
  // summary:
